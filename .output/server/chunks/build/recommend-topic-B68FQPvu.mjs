...
function useGetMyRecommendTopics(params, options) {
  ...
  const items = computed(() => {
    var _a;
    return ((_a = query.data.value) == null ? void 0 : _a.data[0]) || null;
  });
  return {
    ...query,
    items
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (unref(items) && !unref(isUpdate)) {
              ...
              _push2(`</div><div${_scopeId}><span class="font-weight-bold mr-2"${_scopeId}>T\xEAn \u0111\u1EC1 t\xE0i \u0111\u1EC1 xu\u1EA5t:</span><span${_scopeId}>${ssrInterpolate(unref(items).ten)}</span></div><div${_scopeId}><span class="font-weight-bold mr-2"${_scopeId}>M\xF4 t\u1EA3:</span><span${_scopeId}>${ssrInterpolate(unref(items).description)}</span></div><div${_scopeId}><span class="font-weight-bold mr-2"${_scopeId}>Gi\u1EA3ng vi\xEAn:</span><span${_scopeId}>${ssrInterpolate((_a = unref(items).teacher) == null ? void 0 : _a.hodem)} ${ssrInterpolate((_b = unref(items).teacher) == null ? void 0 : _b.ten)}</span></div><div${_scopeId}><span class="font-weight-bold mr-2"${_scopeId}>C\xF4ng ngh\u1EC7 s\u1EED d\u1EE5ng:</span><span${_scopeId}>${ssrInterpolate(unref(items).knowledge)}</span></div>`);
            ...
            return [
              ...
              unref(items) && !unref(isUpdate) ? (openBlock(), createBlock("div", {
                key: 1,
                ...
                createVNode("div", null, [
                  ...
                  createVNode("span", null, toDisplayString((_c = unref(items).teacher) == null ? void 0 : _c.hodem) + " " + toDisplayString((_d = unref(items).teacher) == null ? void 0 : _d.ten), 1)
                ]),
                createVNode("div", null, [
...
//# sourceMappingURL=recommend-topic-B68FQPvu.mjs.map
