  ...
  setup(__props, { emit: __emit }) {
    ...
    const deleteLO = (isActive) => {
      $api.lo.deleteLO(props.lo.id).then(() => {
        $toast.success("X\xF3a LO th\xE0nh c\xF4ng");
        ...
        default: withCtx(({ isActive }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$6, {
              ...
              "cancel-text": "H\u1EE7y",
              "submit-text": "X\xF3a",
              title: "X\xE1c nh\u1EADn x\xF3a LO",
              onCancel: ($event) => isActive.value = false,
              onSubmit: ($event) => deleteLO(isActive)
            }, {
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` X\xF3a LO <strong${_scopeId2}>${ssrInterpolate(__props.lo.main_criteria)}</strong> kh\u1ECFi h\u1EC7 th\u1ED1ng? </span></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center text-warning" }, [
                      createVNode("span", null, [
                        ...
                        createTextVNode(" X\xF3a LO "),
                        createVNode("strong", null, toDisplayString(__props.lo.main_criteria), 1),
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/admin/organisms/DeleteLOConfirmDialog.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const headers = [
      ...
      { title: "Ti\xEAu ch\xED \u0111\xE1nh gi\xE1", key: "main_criteria", width: "45%", minWidth: 350 },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_admin_organisms_create_l_o = _sfc_main$3;
...
//# sourceMappingURL=lo-D6Eu7my3.mjs.map
