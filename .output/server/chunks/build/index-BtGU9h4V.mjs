...
import { V as VDataTable, n as VTable } from './VDataTable-XVgdzRb7.mjs';
import { format } from 'date-fns';
import { u as useGetStudentReportTopics } from './use-get-student-report-topic-D56Ykyjs.mjs';
import { _ as _sfc_main$4 } from './AppTextField-DdQ0O2ei.mjs';
import { V as VExpansionPanels, a as VExpansionPanel, b as VExpansionPanelTitle, c as VExpansionPanelText } from './VExpansionPanels-B1i2T9ll.mjs';
      ...
      _push(ssrRenderComponent(_sfc_main$3, mergeProps({
        ...
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VTable, { class: "elevation-1" }, {
              default: withCtx((_22, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(unref(items), (lo, index) => {
                  ...
                  return [
                    ...
                    createVNode("tbody", null, [
                      (openBlock(true), createBlock(Fragment, null, renderList(unref(items), (lo, index) => {
            ...
            _push2(`<div class="text-center font-weight-bold text-error py-2"${_scopeId}><span${_scopeId}>\u0110i\u1EC3m t\u1ED5ng:</span></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "text-center font-weight-bold text-error py-2" }, [
                createVNode("span", null, "\u0110i\u1EC3m t\u1ED5ng:")
              ])
            ];
          }
        }),
...
//# sourceMappingURL=index-BtGU9h4V.mjs.map
