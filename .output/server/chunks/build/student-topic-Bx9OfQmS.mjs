      ...
      _push(ssrRenderComponent(VCard, {
        ...
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VBtn, {
              class: "mr-2",
              disabled: unref(serverOptions).page <= 1,
              icon: "mdi-chevron-left",
              size: "x-small",
              variant: "outlined",
              onClick: ($event) => unref(serverOptions).page--
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(VBtn, {
              class: "mr-2",
              disabled: unref(items).length < 100,
            ...
            _push2(ssrRenderComponent(VDataTable, {
              ...
              "item.index": withCtx(({ index }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span${_scopeId2}>${ssrInterpolate((unref(serverOptions).page - 1) * 100 + index + 1)}</span>`);
                } else {
                  return [
                    createVNode("span", null, toDisplayString((unref(serverOptions).page - 1) * 100 + index + 1), 1)
                  ];
                }
              }),
...
//# sourceMappingURL=student-topic-Bx9OfQmS.mjs.map
