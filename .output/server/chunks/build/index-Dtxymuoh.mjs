          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VDataTableVirtual, {
              ...
              "item.numberStudent": withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span${_scopeId2}>x/${ssrInterpolate(item.numberStudent)}</span>`);
                } else {
                  return [
                    createVNode("span", null, "x/" + toDisplayString(item.numberStudent), 1)
                  ];
                }
              }),
...
//# sourceMappingURL=index-Dtxymuoh.mjs.map
