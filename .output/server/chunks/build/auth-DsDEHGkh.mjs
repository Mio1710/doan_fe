          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(VListItem, {
                "prepend-icon": unref(CurrentSemesterMenu).icon,
                title: unref(CurrentSemesterMenu).title,
                to: unref(CurrentSemesterMenu).to
...
//# sourceMappingURL=auth-DsDEHGkh.mjs.map
