...
import { j as propsFactory, g as genericComponent, h as useRender, b as useNuxtApp, V as VBtn, f as VSpacer, b6 as useAuth } from './server.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const headers = [
      ...
      { title: "M\xF4 t\u1EA3", key: "description", width: "25%", minWidth: 250 },
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$4, {
        ...
        numberStudent: (_a = __props.items) == null ? void 0 : _a.students.length
      }, null, _parent));
...
//# sourceMappingURL=index-uVnt78Ys.mjs.map
