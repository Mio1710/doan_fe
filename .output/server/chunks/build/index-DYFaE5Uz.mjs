    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VDataTable, mergeProps({
        ...
        "item.numberStudent": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span${_scopeId}>${ssrInterpolate(item.currentNumberStudent)}/${ssrInterpolate(item == null ? void 0 : item.numberStudent)}</span>`);
          } else {
            return [
              createVNode("span", null, toDisplayString(item.currentNumberStudent) + "/" + toDisplayString(item == null ? void 0 : item.numberStudent), 1)
            ];
          }
        }),
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VDataTable, {
        ...
        "item.numberStudent": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(__props.numberStudent)}/${ssrInterpolate(item == null ? void 0 : item.numberStudent)}`);
          } else {
            return [
              createTextVNode(toDisplayString(__props.numberStudent) + "/" + toDisplayString(item == null ? void 0 : item.numberStudent), 1)
            ];
          }
        }),
        _: 1
            ...
            return [
              unref(items).topic ? (openBlock(), createBlock("div", {
                ...
                !unref(items).topic.topic_id || unref(viewAll) ? (openBlock(), createBlock(_sfc_main$6, {
                  ...
                  "topic-id": unref(items).topic.topic_id,
                  onViewAll: ($event) => viewAll.value = false
                }, null, 8, ["topic-id", "onViewAll"])) : (openBlock(), createBlock(_sfc_main$1, {
                  key: 1,
                  items: unref(items),
                  onRefetch: ($event) => unref(refetch)(),
                  onViewAll: ($event) => viewAll.value = true
...
//# sourceMappingURL=index-DYFaE5Uz.mjs.map
