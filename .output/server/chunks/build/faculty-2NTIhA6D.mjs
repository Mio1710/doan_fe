...
import { _ as _sfc_main$7 } from './AppTextField-DdQ0O2ei.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "DeleteFacultyConfirmDialog",
  __ssrInlineRender: true,
  props: {
    faculty: {
      type: Object,
            ...
            _push2(ssrRenderComponent(_sfc_main$6, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` X\xF3a <strong${_scopeId2}>${ssrInterpolate(__props.faculty.ten)} - ${ssrInterpolate(__props.faculty.maso)}</strong> kh\u1ECFi h\u1EC7 th\u1ED1ng? </span></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center text-warning" }, [
                      createVNode("span", null, [
                        ...
                        createTextVNode(" X\xF3a "),
                        createVNode("strong", null, toDisplayString(__props.faculty.ten) + " - " + toDisplayString(__props.faculty.maso), 1),
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/admin/super/molecules/DeleteFacultyConfirmDialog.vue");
...
//# sourceMappingURL=faculty-2NTIhA6D.mjs.map
